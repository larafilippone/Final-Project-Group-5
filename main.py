...
go_to_amazon_button = tk.Button(
    left_frame, 
    text="Go to Amazon", 
    command=lambda: open_amazon(product_url)
)
...
scrape_button = tk.Button(right_frame, text="Scrape Reviews and Analyze", command=start_scraping_thread, state=tk.DISABLED)
